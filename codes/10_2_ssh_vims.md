...
✅ 명령어 힌트: `/검색`, `yy`, `p`, `:wq`
```
[chohyunjun@192.168.0.40 ~/Downloads/gij/vim_crud_practice/comp2]$ cat ./todo.txt
1. Clean the house
2. Buy groceries
3. Call Mom
2. Buy groceries
...
✅ 명령어 힌트: `G`, `o`, `i`, `ESC`, `:wq`
```
[chohyunjun@192.168.0.40 ~/Downloads/gij/vim_crud_practice/comp1]$ cat fruits.txt
Apple
Banana
Cherry
Durian
...
✅ 명령어 힌트: `:%s///`, `yy`, `p`, `:wq`
```
[chohyunjun@192.168.0.40 ~/Downloads/gij/vim_crud_practice/comp3]$ cat users.csv
Name,Email
